...
tap_install_list = ['bash','bat','bottom','broot','btop','cheat','cmake','cppman','dasel','difftastic','dog','dos2unix','duf','dust','exa','fd','fennel','fontconfig','fx','fzf','gcc','git','git-delta','git-filter-repo','glances','go','gotop','httpie','hyperfine','hexyl','llvm','neovim','neofetch','nnn','node','pkg-config','python@3.9','rg','rlwrap','rust-analyzer','sd','ssh-copy-id','the_silver_searcher','tmux','vim','wget']
