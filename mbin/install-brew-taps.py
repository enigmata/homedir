...
tap_install_list = ['bash','bat','broot','cheat','cmake','cppman','dos2unix','duf','dust','exa','fd','fontconfig','fzf','gcc','git','git-delta','git-filter-repo','glances','go','gotop','httpie','hyperfine','llvm','neovim','neofetch','nnn','pkg-config','python@3.9','rg','rlwrap','rust-analyzer','ssh-copy-id','the_silver_searcher','tmux','wget']
