...
tap_install_list = ['bash','bat','cmake','cppman','dos2unix','duf','dust','exa','fontconfig','fzf','gcc','git','git-delta','git-filter-repo','go','gotop','llvm','neovim','neofetch','nnn','pkg-config','python@3.9','rg','rlwrap','ssh-copy-id','the_silver_searcher','tmux','tree','wget']
